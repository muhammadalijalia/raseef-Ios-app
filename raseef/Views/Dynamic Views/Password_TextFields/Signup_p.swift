...
//import SwiftUI
//
//struct Signup_p: View {
//    let screenSize = UIScreen.main.bounds.size;
//    @State private var secured: Bool = true
//    var icon: Icon?
//    var systemIcon: SystemIcon?
//    var placeHolder: String
//    @Binding var signup_password: String
//    
//    init(placeHolder: String, signup_password: Binding<String>) {
//       // self.icon = icon
...
//            HStack(spacing: 0) {
//                if secured {
//                    SecureField(placeHolder, text: $signup_password)
...
//                }
//                else {
//                    TextField(placeHolder, text:  $signup_password)
//                        .textContentType(.password)
//                        .accentColor(.customGray)
//                        .multilineTextAlignment(.leading)
//                        .autocapitalization(.none)
