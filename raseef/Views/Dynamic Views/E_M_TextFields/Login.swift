...
//    @Binding var login_email: String
//    
//    init(icon: Icon, placeHolder: String, login_email: Binding<String>) {
//        self.icon = icon
...
//    }
//    
//    init(systemIcon: SystemIcon, placeHolder: String, login_email: Binding<String>) {
