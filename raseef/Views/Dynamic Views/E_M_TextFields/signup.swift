...
//    @Binding var signup_email: String
//    
//    init(icon: Icon, placeHolder: String, signup_email: Binding<String>) {
//        self.icon = icon
//        self.placeHolder = placeHolder
//        self._signup_email = signup_email
//        self.systemIcon = nil
//    }
//    
//    init(systemIcon: SystemIcon, placeHolder: String, signup_email: Binding<String>) {
