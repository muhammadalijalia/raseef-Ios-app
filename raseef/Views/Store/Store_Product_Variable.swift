//
//  Store_Product_Variable.swift
//  raseef
//
//  Created by Teamx tec on 09/12/2022.
//
...
struct Store_Product_Variable: View {
    ...
    @State var Att_value :[String:Int] = [:]
...
//                                                        //option att id
                                                  ...
                                                  //      print(productType.slugDict[value]?[v].value ?? "")
                                                                                                
                     
                
//                            for i in productType.slugDict.keys.sorted()
//                        {
//                                for j in 0..<productType.slugDict[i]?.count
//                                {
//                        if self.productType.slugDict[value]?[v].value ==                                         (self.productType.slugDict[i]?[j].attribute?.slug)!
//
//                           {
//
//                                                                }
...
//                                            if (v == 0)
//                                                    {
//                                                self.productType.slugDict[value]?[0].check = true
//
//                                                for i in 0..<self.productType.slugDict[value]!.count{
//
//                                                    self.productType.slugDict[value]?[i].check = false
//
//                                                }
//
//
//                                            }
                        ...
                        for i in 0..<self.productType.slugDict[value]!.count
                                                            {
                        if select_OpId == self.productType.slugDict[value]?[i].id
                                                                {
                        self.productType.slugDict[value]?[i].check = true
                                   print(productType.slugDict)
                                                                }
                                                                else
                                                                {
                                                                    self.productType.slugDict[value]?[i].check  = false
...
//                                                        for i in 0..<self.productType.slugDict[value]!.count
//                                                        {
//                                                      if(self.productType.slugDict[value]?[i].check ==
//                                                            self.productType.slugDict[value]?[v].check)
//
//                                                            {
//                                                          self.productType.slugDict[value]?[i].check = true
//                                                          self.productType.slugDict[value]?[i+1].check = false
//                                                          self.productType.slugDict[value]?[i-1].check = false
//                                                          print(productType.slugDict)
//                                                      }
//                                                            else{
...
//                                                        }
                                                        //print(productType.slugDict)
                                                      //  print(self.productType.slugDict)
//                                                        for key in productType.slugDict.keys.sorted(){
//
//                                                            for  indx in 0..<productType.slugDict.values.count{
//
//                                                                print(indx)
//                                                            }
//
//
//                                                        }
           for i in 0..<productType.variationsOp.count
                                                                                            {
            for j in 0..<productType.variationsOp[i].options!.count{
                  if productType.variationsOp[i].options?[j].value == productType.slugDict[value]?[v].value
                                                                    &&
                self.productType.slugDict[value]?[v].check == true
                                                                    
                                                                {
                      
                
                  // self.Var_value.append(productType.variationsOp[i].price!)
                     
                                                                    
                                                                }
                                                                else{
                                        //self.Var_value.removeDuplicates()
                                                                }
                                                            
                                                            }
                                              print("ia m outside in J lop")
                                                        }
                                        print("ia m outside i lop")
                                                    }
                                                label:{
                                                
                                                        
                                                        if  (self.productType.slugDict[value]?[v].check == true)
                                                        {
...
//                                                    }
            ...
            .onAppear{
                ...
                Task
                {
                    ...
                    if let slug = UserDefaults.standard.string(forKey: "product_slug")
                    {
                        await
                       // "blush-on-facial-care---ny"
                        productType.products(slug: slug)
                    }
                    else{
...
struct Store_Product_Variable_Previews: PreviewProvider {
