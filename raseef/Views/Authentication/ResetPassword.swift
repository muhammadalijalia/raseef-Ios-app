...
struct ResetPassword: View {
   ...
   @ObservedObject var Resetview = Reset_ViewModel();
...
//                                    .padding(.top, 0)
                            ...
                            Button {
                                ...
                                let email: String? = UserDefaults.standard.string(forKey: "forgetEmail")
                           //     let email: String? = UserDefaults.standard.string(forKey: "otpPostString.email");
                                ...
                                ResetpostString.email = email!;
                                                    Resetview.Reset(email: ResetpostString.email,token:ResetpostString.token,reset_new_password:ResetpostString.password,
                                                                    reset_confirm_password:ResetpostString.confirm_password)
