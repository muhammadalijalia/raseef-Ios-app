...
//
//public struct OTPTextField_View: View {
//    
//    var maxDigits: Int = 6
...
//                                let  ReuqestFromRegistrationViewModel = UserDefaults.standard.bool(forKey: "ReuqestFromRegistrationViewModel");
//                                
//                                
//                                if (ReuqestFromRegistrationViewModel == true)
//                                {
//                                    let phone_number =  UserDefaults.standard.string(forKey: "phone_number")
//                                    //         FVm.forget(email: phone_number!)
//                                    
//                                }
//                                else
//                                {
...
//                            Button {
//                                UserDefaults.standard.set(otpPostString.token, forKey: "otpPostString.token")
...
//                                
//                                
//                             self.otpVM.VeryOtp(token:otpPostString.token)
//                                
//                            
...
//        let boundPin = Binding<String>(get: { self.otpPostString.token }, set: { newValue in
//            self.otpPostString.token = newValue
//            self.submitPin()
//            
//        })
//        
...
//        guard self.otpPostString.token.isEmpty else {
//            return
//        }
//        
//        if self.otpPostString.token.count == maxDigits {
//            isDisabled = true
//            
//            handler(self.otpPostString.token) { isSuccess in
//                if isSuccess {
//                    print("pin matched, go to next page, no action to perfrom here")
//                } else {
//                    self.otpPostString.token = ""
//                    isDisabled = false
...
//        if self.otpPostString.token.count > maxDigits {
//            self.otpPostString.token = String(self.otpPostString.token.prefix(maxDigits))
//            submitPin()
//        }
//    }
//    
//    private func getDigits(at index: Int) -> String {
//        if index >= self.otpPostString.token.count {
//            return ""
//        }
//        
//            return self.otpPostString.token.digits[index].numberString
//    }
...
//}
//}
//struct OTPTextField_View_Previews1: PreviewProvider {
