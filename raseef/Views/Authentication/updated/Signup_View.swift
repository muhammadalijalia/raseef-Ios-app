...
//                        NavigationLink("",destination: Otp_TF_Signup()
//                            .navigationBarTitle("")
//                            .navigationBarBackButtonHidden(true)
//                                       
...
//                                                Spacer()
//                                            }
//                                            signup(systemIcon: .person, placeHolder: "Name", signup_email: $registerPostString.name)
...
//                                                Spacer()
//                                            }
//                                            signup(icon: .email, placeHolder: "Email address", signup_email: $registerPostString.email)
...
//                                            }
//                                            
//                                            signup(icon: .mobile_model, placeHolder: "Mobile Number", signup_email: $registerPostString.contact)
...
//                                            
//                                            Signup_p(placeHolder: "Password", signup_password: $registerPostString.password)
//                                            
//                                            
//                                        }
//                                        
...
//}
////
//struct Signup_View_Previews2: PreviewProvider {
